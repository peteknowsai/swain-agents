---
description: Use the skip CLI for task coordination, card creation, messaging, sessions, and agent management. Invoke this skill when you need to interact with the Hey Skip platform - claim tasks, update status, create cards, send messages, or manage workflows.
---

# Obsidian Vault — Full Reference

All markdown files you write — memory, daily notes, `.claude/memory/` — sync to an Obsidian vault. Write them so they render properly: YAML frontmatter, wikilinks between notes, tags for categorization.
